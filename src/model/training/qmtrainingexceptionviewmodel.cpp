// qmtrainingexceptionviewmodel.cpp is part of QualificationMatrix
//
...
void QMTrainingExceptionViewModel::initModel()
{
    // The name of the Table.
    setTable("TrainExceptionView");
    ...
    setHeaderData(3, Qt::Horizontal, tr("Erläuterung"));
}
