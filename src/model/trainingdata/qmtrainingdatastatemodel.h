// qmtrainingdatastatemodel.h is part of QualificationMatrix
//
...
public:
    ...
    /// \param parent
    /// \param db
    explicit QMTrainingDataStateModel(QObject *parent = nullptr, const QSqlDatabase &db = QSqlDatabase());
};

#endif // QMTRAININGDATASTATEMODEL_H
