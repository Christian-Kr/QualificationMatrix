//
// importcsvdialog.cpp is part of QualificationMatrix
//
...
ImportCsvDialog::ImportCsvDialog(QWidget *parent)
    : QDialog(parent), ui(new Ui::ImportCsvDialog), trainModel(nullptr), employeeModel(nullptr),
...
void ImportCsvDialog::updateData()
{
...
void ImportCsvDialog::openImportFile()
{
...
void ImportCsvDialog::openBackupFile()
{
...
void ImportCsvDialog::handleErrorLine(QString &line)
{
...
bool ImportCsvDialog::checkBackupFile()
{
    if (ui->gbcSaveNotImported->isChecked()) {
...
void ImportCsvDialog::parseCsv(QFile &importFile)
{
