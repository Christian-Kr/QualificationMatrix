// qmamsaccessmodemodel.cpp is part of QualificationMatrix
//
...
#include "qmamsaccessmodemodel.h"

QMAMSAccessModeModel::QMAMSAccessModeModel(QObject *parent,
...
void QMAMSAccessModeModel::initModel()
{
    // The name of the Table.
    setTable("AMSAccessMode");
    ...
    setHeaderData(3, Qt::Horizontal, tr("Beschreibung"));
}
