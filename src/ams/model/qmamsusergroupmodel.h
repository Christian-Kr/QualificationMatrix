// qmamsusergroupmodel.h is part of QualificationMatrix
//
...
#ifndef QMAMSUSERGROUPMODEL_H
#define QMAMSUSERGROUPMODEL_H

#include "framework/qmsqltablemodel.h"

/// User group correlation table for the access management system.
/// \author Christian Kr, Copyright 2020
class QMAMSUserGroupModel: public QMSqlTableModel
{
    Q_OBJECT
...
public:
    ...
    explicit QMAMSUserGroupModel(QObject *parent = nullptr,
