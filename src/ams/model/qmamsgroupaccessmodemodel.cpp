// qmamsgroupaccessmodemodel.cpp is part of QualificationMatrix
//
...
#include "qmamsgroupaccessmodemodel.h"

QMAMSGroupAccessModeModel::QMAMSGroupAccessModeModel(QObject *parent,
...
void QMAMSGroupAccessModeModel::initModel()
{
    // The name of the Table.
    setTable("AMSGroupAccessMode");
