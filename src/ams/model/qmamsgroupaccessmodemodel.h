// qmamsgroupaccessmodemodel.h is part of QualificationMatrix
//
...
#ifndef QMAMSGROUPACCESSMODEMODEL_H
#define QMAMSGROUPACCESSMODEMODEL_H

#include "framework/qmsqltablemodel.h"

/// Group access mode table for the access management system.
/// \author Christian Kr, Copyright 2020
class QMAMSGroupAccessModeModel: public QMSqlTableModel
{
    Q_OBJECT
...
public:
    ...
    explicit QMAMSGroupAccessModeModel(QObject *parent = nullptr,
...
#endif // QMAMSGROUPACCESSMODEMODEL_H
