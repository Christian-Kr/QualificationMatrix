// qmamsaccessmodemodel.h is part of QualificationMatrix
//
...
#ifndef QMAMSACCESSMODEMODEL_H
#define QMAMSACCESSMODEMODEL_H

#include "framework/qmsqltablemodel.h"

/// Access mode table for the access management system.
/// \author Christian Kr, Copyright 2020
class QMAMSAccessModeModel: public QMSqlTableModel
{
    Q_OBJECT
...
public:
    ...
    explicit QMAMSAccessModeModel(QObject *parent = nullptr,
