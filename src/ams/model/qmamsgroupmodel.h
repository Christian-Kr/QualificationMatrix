// qmamsgroupmodel.h is part of QualificationMatrix
//
...
#ifndef QMAMSGROUPMODEL_H
#define QMAMSGROUPMODEL_H

#include "framework/qmsqltablemodel.h"

/// Group table for the access management system.
/// \author Christian Kr, Copyright 2020
class QMAMSGroupModel: public QMSqlTableModel
{
    Q_OBJECT
...
public:
    ...
    explicit QMAMSGroupModel(QObject *parent = nullptr, const QSqlDatabase &db = QSqlDatabase());
