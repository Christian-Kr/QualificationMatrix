...
// Enum: The WIN_MODE. Every time the mode will be switched and a new widget will be shown, the old
// objects will be deleted. This makes sure, nothing unexpected happens or blocks access in unused
// application parts.
enum class WIN_MODE {
